...
export default function Dashboard(props: { slots: DashboardSlot[] }) {
  ...
  return (
    <div className="grid h-full w-full grid-cols-1 gap-2 overflow-y-auto sm:grid-cols-2 sm:grid-rows-2 sm:gap-3 sm:overflow-visible">
      <div className="overflow-hidden empty:hidden sm:col-start-1 sm:row-start-1">
        {topLeft ? <DashboardCard key={topLeft.id} data={topLeft.data} full={false} /> : null}
      </div>
      <div className="overflow-hidden empty:hidden sm:col-start-2 sm:row-start-1">
        {topRight ? <DashboardCard key={topRight.id} data={topRight.data} full={false} /> : null}
      </div>
      <div className="overflow-hidden empty:hidden sm:col-start-1 sm:row-start-2">
        {bottomLeft ? <DashboardCard key={bottomLeft.id} data={bottomLeft.data} full={false} /> : null}
      </div>
      <div className="overflow-hidden empty:hidden sm:col-start-2 sm:row-start-2">
