...
import type { DashboardData, DashboardRegion, DashboardSize } from "./Dashboard";
...
function friendlyRegionName(region: DashboardRegion): string {
...
export default function RealtimeVoice({
  ...
  const relayToolCall = useCallback(
    ...
    [log, onShowDashboard, onDismissDashboard, getDashboardState, sendToolResult]
  );
